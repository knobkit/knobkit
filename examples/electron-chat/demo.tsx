...
const app = knobkit({
  ...
  description: "Qwen3.5-0.8B runs entirely inside the Electron window — chat, and attach an image with +.",
...
app.setup(async () => {
  ...
  model = await Qwen3_5ForConditionalGeneration.from_pretrained(MODEL, {
    ...
    device: "webgpu", // Electron's renderer is Chromium; main.cjs enables WebGPU. Use "wasm" if a machine lacks it.
  });
